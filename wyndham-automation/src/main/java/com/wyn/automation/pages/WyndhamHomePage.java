...
public class WyndhamHomePage extends BasePage<WyndhamHomePage> {
	ExtentReports extent;
	ExtentTest test;
	static XSSFRow row = ExcelUtils.getRowData("BrandsBooking1", 1);
	...
	public WyndhamHomePage() throws Exception {
		super(Browsers.getBrowser());
		driver = Browsers.getBrowser();
		currentPageUrl("/ramada");
		ExcelUtils.load("BrandsBooking1");
	}

	public WyndhamHomePage openPage() throws Exception {
		return super.openPage(WyndhamHomePage.class);
	}
	...
	public String Click(int number) throws Exception {
		...
		Roomsadd(Rooms, Adults, Childrens, rooms, adult, childrens);
...
//		Thread.sleep(2000);
	...
	public void changeCheckIn(String ScreenName,int TestNo) throws Exception {
		XSSFRow row = ExcelUtils.getRowData(ScreenName, TestNo);
	...
	public void changeCheckOut(String ScreenName,int TestNo) throws InterruptedException {
...
//		Thread.sleep(8000);
	...
	public  void enterDestination(String ScreenName,int TestNo) throws Exception {
		destination.clear();
		XSSFRow row = ExcelUtils.getRowData(ScreenName, TestNo);
	...
	public static void Roomsadd(WebElement element_Rooms, WebElement element_Adult, WebElement element_Children,
	...
	public void errorvalidation() throws Exception {
		...
		RoomsAndGuestButton.click();
        Thread.sleep(1200);
		Roomsadd(Rooms, Adults, Childrens, "1", "1", "1");
		Search.click();
		Thread.sleep(1200);
	...
	public void Deallanding() throws Exception {
...
//		}
	...
	public void leavingsixtyMinIdle() {
	...
	public void validateLogin() throws Exception {
		Boolean value=driver.findElement(By.xpath("//a[@class='wr-logged-points']")).getText().equals("");
        if(value){
        	validateLogin();
        }
		Thread.sleep(3500);
        
 		String member=driver.findElement(By.xpath("//a[@class='wr-logged-points']")).getText();
 		String points=driver.findElement(By.xpath("//a[@class='wr-logged-points-label']")).getText();
 	   if(member.equals("")||points.equals("")){
 		   Assert.assertTrue(false);
 	   }
