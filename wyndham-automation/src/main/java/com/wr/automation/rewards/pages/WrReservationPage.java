...
public class WrReservationPage extends BasePage<WrReservationPage> {
	...
	public WrReservationPage() {
		super(Browsers.getBrowser());
		driver = Browsers.getBrowser();
		currentPageUrl("wyndham");
	}

	public WrReservationPage openPage() throws Exception {
		return super.openPage(WrReservationPage.class);
	}
	...
	public String completeReservation() throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='checkbox10']/following-sibling::span/span")).click();
		Submitbutton.click();
...
//		}
		...
		String confrimationNumber=driver.findElement(By.xpath("//p[@class='confirmation-number']/span")).getText();
	...
	public void populategoFree() {
		XSSFRow row = ExcelUtils.getRowData("Screen2", 1);
		Street.clear();
...
//		Boolean isPresent = driver.findElements(By.cssSelector("input[id='confirmEmail']")).size() > 0;
		XSSFRow row = ExcelUtils.getRowData("WrBooking2", number);
...
//		}
	...
	public String Bookingform_validation() throws Exception {
	...
	public void goFreeCompleteReservation() {
		AutomationUtils.Fluentwait(driver, "input[id='myc_credit_number']");
		selectDropDownText(Country,"United States");
		selectDropDownText(State,"Alabama");
		Postalcode.clear();
